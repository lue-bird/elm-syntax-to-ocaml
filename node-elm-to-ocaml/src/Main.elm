...
interface state =
    case state of
                            ...
                            Ok elmJson ->
                                case elmJson of
                                    ...
                                    Elm.Project.Package _ ->
                                        ElmJsonReadFailed
                                            "You're in a package but elm-to-ocaml only works for applications."
                    )
        ...
        Finished result ->
            case result of
                Err error ->
                    errorInterface "Failed to write the bundled code into lib/Elm.ml."

                Ok () ->
                    Node.standardOutWrite
                        "Successfully wrote the bundled code into lib/Elm.ml.\n"
